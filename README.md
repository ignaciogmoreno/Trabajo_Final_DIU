...
Con esta malla receptora podemos hacernos una idea de que es en lo que funciona y que es en lo que no [yuzin](https://yuzin.com/), los siguientes puntos de la práctica dos están orientados a la creación de un nuevo diseño en base a uno anterior, pero en este caso, voy a rediseñar la página añadiendo mejoras que podamos haber visto.
